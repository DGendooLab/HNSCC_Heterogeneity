...
cnv_val_c_268[,2]<-2^(cnv_val_c_268[,1])
colnames(cnv_val_c_268)<-c("Log_Value","CNV_value")
write.csv(cnv_val_c_268, file = "~/Desktop/CNV_Values/DMR/CNV_DMR_core268.csv", row.names = TRUE)

cnv_val_p_268<-as.data.frame(plasma_268@detail$ratio)
cnv_val_p_268[,2]<-2^(cnv_val_p_268[,1])
colnames(cnv_val_p_268)<-c("Log_Value","CNV_value")
write.csv(cnv_val_p_268, file = "~/Desktop/CNV_Values/DMR/CNV_DMR_plasma268.csv", row.names = TRUE)
...
write.csv(cnv_val_c_268_TCGA19, file = "~/Desktop/CNV_Values/TCGA19/CNV_core268_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_268_TCGA19, file = "~/Desktop/CNV_Values/TCGA19/CNV_plasma268_TCGA19.csv", row.names = TRUE)
