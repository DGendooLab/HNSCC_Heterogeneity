...
targets_CNV <- read.metharray.sheet("~/DATA/Sample Sheets", pattern="GB160121-KP Sample Sheet 450k_noHPV.csv")
normal_CNV<-read.metharray.sheet("~/DATA/Sample Sheets", pattern="GB160121-KP Sample Sheet 450k_normal.csv")
target_all<-read.metharray.sheet("~/DATA/Sample Sheets", pattern = "GB160121-KP Sample Sheet 450k_alltissues copy 2")
...
The following code is to annotate the data with known methylated regions
```{r}
#Data from DMR  analysis in Thesis_HNSCC RMD. Creating a data frame with the overlapping 279 regions and corresponding details.
...
#pdf("~/20_DMR_genes_GenomePLot.pdf",height = 10, width=20)
...
#pdf("~/268_20_DMR_genes_GenomePLot.pdf")
CNV.genomeplot(core_268)
CNV.genomeplot(plasma_268)
#dev.off()
 
#pdf("~/268_19_TCGAgenes_GenomePLot.pdf")
...
#TCGA Genome Plot
pdf("~/TCGA_GenomePLot.pdf", height = 10, width=20)
par(mfrow=c(5,4))
...
pdf("~/DMR_GenomePLot_detailplotwrap.pdf", height = 10, width=20)
par(mfrow=c(5,4))
...
pdf("~/DMR_GenomePLot_genomeplot.pdf", height = 10, width=20)
par(mfrow=c(5,4))
...
pdf("~/TCGA_GenomePLot_detailplotwrap.pdf", height = 10, width=20)
par(mfrow=c(5,4))
...
pdf("~/TCGA_GenomePLot_genomeplot.pdf", height = 10, width=20)
par(mfrow=c(5,4))
logratio<-function(x){
...
write.csv(cnv_val_df_DMR, file = "~/DMR/CNV_DMR_mar107.csv", row.names = TRUE)
...
write.csv(cnv_val_c_107, file = "~/DMR/CNV_DMR_core107.csv", row.names = TRUE)
...
write.csv(cnv_val_p_107, file = "~/DMR/CNV_DMR_plasma107.csv", row.names = TRUE)
...
write.csv(cnv_val_pB_107, file = "~/DMR/CNV_DMR_plasmaB107.csv", row.names = TRUE)
...
write.csv(cnv_val_pR_107, file = "~/DMR/CNV_DMR_plasmaR107.csv", row.names = TRUE)
...
write.csv(cnv_val_m_199, file = "~/DMR/CNV_DMR_mar199.csv", row.names = TRUE)
...
write.csv(cnv_val_c_199, file = "~/DMR/CNV_DMR_core199.csv", row.names = TRUE)
...
write.csv(cnv_val_p_199, file = "~/DMR/CNV_DMR_plasma199.csv", row.names = TRUE)
...
write.csv(cnv_val_pB_199, file = "~/DMR/CNV_DMR_plasmaB199.csv", row.names = TRUE)
...
write.csv(cnv_val_m_264, file = "~/DMR/CNV_DMR_mar264.csv", row.names = TRUE)
...
write.csv(cnv_val_c_264, file = "~/DMR/CNV_DMR_core264.csv", row.names = TRUE)
...
write.csv(cnv_val_p_264, file = "~/DMR/CNV_DMR_plasma264.csv", row.names = TRUE)
...
write.csv(cnv_val_m_276, file = "~/DMR/CNV_DMR_mar276.csv", row.names = TRUE)
...
write.csv(cnv_val_c_276, file = "~/DMR/CNV_DMR_core276.csv", row.names = TRUE)
...
write.csv(cnv_val_p_276, file = "~/DMR/CNV_DMR_plasma276.csv", row.names = TRUE)
...
write.csv(cnv_val_m_288, file = "~/DMR/CNV_DMR_mar288.csv", row.names = TRUE)
...
write.csv(cnv_val_c_288, file = "~/DMR/CNV_DMR_core288.csv", row.names = TRUE)
...
write.csv(cnv_val_p_288, file = "~/DMR/CNV_DMR_plasma288.csv", row.names = TRUE)
...
write.csv(cnv_val_c_268, file = "~/DMR/CNV_DMR_core288.csv", row.names = TRUE)
...
write.csv(cnv_val_p_268, file = "~/DMR/CNV_DMR_plasma288.csv", row.names = TRUE)
...
write.csv(cnv_val_m_124, file = "~/DMR/CNV_DMR_mar124.csv", row.names = TRUE)
...
write.csv(cnv_val_c_124, file = "~/DMR/CNV_DMR_core124.csv", row.names = TRUE)
...
write.csv(cnv_val_p_124, file = "~/DMR/CNV_DMR_plasma124.csv", row.names = TRUE)
...
write.csv(cnv_val_m_207, file = "~/DMR/CNV_DMR_mar207.csv", row.names = TRUE)
...
write.csv(cnv_val_c_207, file = "~/DMR/CNV_DMR_core207.csv", row.names = TRUE)
...
write.csv(cnv_val_p_207, file = "~/DMR/CNV_DMR_plasma207.csv", row.names = TRUE)
...
write.csv(cnv_val_m_166, file = "~/DMR/CNV_DMR_mar166.csv", row.names = TRUE)
...
write.csv(cnv_val_c_166, file = "~/DMR/CNV_DMR_core166.csv", row.names = TRUE)
...
write.csv(cnv_val_p_166, file = "~/DMR/CNV_DMR_plasma166.csv", row.names = TRUE)
...
write.csv(cnv_val_df_DMR_TCGA19, file = "~/TCGA19/CNV_mar107_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_c_107_TCGA19, file = "~/TCGA19/CNV_core107_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_107_TCGA19, file = "~/TCGA19/CNV_plasma107_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_pB_107_TCGA19, file = "~/TCGA19/CNV_plasmaB107_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_pR_107_TCGA19, file = "~/TCGA19/CNV_plasmaR107_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_m_199_TCGA19, file = "~/TCGA19/CNV_mar199_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_c_199_TCGA19, file = "~/TCGA19/CNV_core199_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_199_TCGA19, file = "~/TCGA19/CNV_plasma199_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_pB_199_TCGA19, file = "~/TCGA19/CNV_plasmaB199_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_m_264_TCGA19, file = "~/TCGA19/CNV_mar264_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_c_264_TCGA19, file = "~/TCGA19/CNV_core264_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_264_TCGA19, file = "~/TCGA19/CNV_plasma264_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_m_276_TCGA19, file = "~/TCGA19/CNV_mar276_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_c_276_TCGA19, file = "~/TCGA19/CNV_core276_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_276_TCGA19, file = "~/TCGA19/CNV_plasma276_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_m_288_TCGA19, file = "~/TCGA19/CNV_mar288_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_c_288_TCGA19, file = "~/TCGA19/CNV_core288_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_288_TCGA19, file = "~/TCGA19/CNV_plasma288_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_c_268_TCGA19, file = "~/TCGA19/CNV_core288_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_268_TCGA19, file = "~/TCGA19/CNV_plasma288_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_m_124_TCGA19, file = "~/TCGA19/CNV_mar124_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_c_124_TCGA19, file = "~/TCGA19/CNV_core124_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_124_TCGA19, file = "~/TCGA19/CNV_plasma124_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_m_207_TCGA19, file = "~/TCGA19/CNV_mar207_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_c_207_TCGA19, file = "~/TCGA19/CNV_core207_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_207_TCGA19, file = "~/TCGA19/CNV_plasma207_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_m_166_TCGA19, file = "~/TCGA19/CNV_mar166_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_c_166_TCGA19, file = "~/TCGA19/CNV_core166_TCGA19.csv", row.names = TRUE)
...
write.csv(cnv_val_p_166_TCGA19, file = "~/TCGA19/CNV_plasma166_TCGA19.csv", row.names = TRUE)
```
