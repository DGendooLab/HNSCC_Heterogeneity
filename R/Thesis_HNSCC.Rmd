...
```{r}
# read in the sample sheet for the experiment
targets_all_tum <- read.metharray.sheet(dataDirectory, pattern="GB160121-KP Sample Sheet 450k_alltissuesTUMOUR.csv") 
targets_nonHPV_tum<- read.metharray.sheet(dataDirectory, pattern="GB160121-KP Sample Sheet 450k_noHPVTumour.csv") 
targets_plasma<- read.metharray.sheet(dataDirectory, pattern="GB160121-KP Sample Sheet 450k_plasma.csv") 
```
